...
- `src/ai_dev_agent_demo/app.py` : mini application de démonstration exécutable (inclut `add(a, b)` pour additionner et `divide(a, b)` pour diviser deux nombres avec gestion de la division par zéro).
